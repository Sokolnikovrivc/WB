...
Public Class Form11
    ...
    Private Sub Button17_Click(sender As Object, e As EventArgs) Handles Button17.Click
        ...
        registryKey.SetValue("TextBox58", TextBox58.Text)
        ...
        registryKey.SetValue("Label40", Label40.Text)
        ...
        registryKey.SetValue("TextBox57", TextBox57.Text)
        ...
        registryKey.SetValue("TextBox63", TextBox63.Text)
        registryKey.SetValue("TextBox62", TextBox62.Text)
        registryKey.SetValue("TextBox61", TextBox61.Text)
        registryKey.SetValue("TextBox60", TextBox60.Text)
        registryKey.SetValue("TextBox59", TextBox59.Text)
        ...
        registryKey.SetValue("TextBox68", TextBox68.Text)
        registryKey.SetValue("TextBox67", TextBox67.Text)
        registryKey.SetValue("TextBox66", TextBox66.Text)
        ...
        Try
            Using connection As SqlConnection = New SqlConnection(connectionString)
                ...
                Form1.TextBox26.Text = table.Rows(0)(24).ToString()
                Form1.TextBox27.Text = table.Rows(0)(25).ToString()
                Form1.TextBox28.Text = table.Rows(0)(26).ToString()
                Form1.TextBox29.Text = table.Rows(0)(27).ToString()
                Form1.TextBox30.Text = table.Rows(0)(28).ToString()
                Form1.TextBox31.Text = table.Rows(0)(29).ToString()
                Form1.TextBox36.Text = table.Rows(0)(30).ToString()
                Form1.TextBox37.Text = table.Rows(0)(31).ToString()
                Form1.TextBox38.Text = table.Rows(0)(32).ToString()
                Form1.TextBox16.Text = table.Rows(0)(33).ToString()
                Form1.TextBox39.Text = table.Rows(0)(34).ToString()
                Form1.TextBox40.Text = table.Rows(0)(35).ToString()
                Form1.TextBox41.Text = table.Rows(0)(36).ToString()
                Form1.TextBox10.Text = table.Rows(0)(37).ToString()
                Form1.TextBox32.Text = table.Rows(0)(38).ToString()
                Form1.TextBox33.Text = table.Rows(0)(39).ToString()
                Form1.TextBox34.Text = table.Rows(0)(40).ToString()
                Form1.TextBox35.Text = table.Rows(0)(41).ToString()
                Form1.TextBox9.Text = table.Rows(0)(42).ToString()
                Form1.TextBox13.Text = table.Rows(0)(43).ToString()
                Form1.TextBox19.Text = table.Rows(0)(44).ToString()
                Form1.TextBox18.Text = table.Rows(0)(45).ToString()
                Form1.Label29.Text = table.Rows(0)(46).ToString()
                Form1.Label57.Text = table.Rows(0)(47).ToString()
                Form1.Label56.Text = table.Rows(0)(48).ToString()
                Form1.Label71.Text = table.Rows(0)(49).ToString()
                Form1.Label73.Text = table.Rows(0)(50).ToString()
                Form1.Label75.Text = table.Rows(0)(51).ToString()
                Form1.Label50.Text = table.Rows(0)(52).ToString()
                Form1.Label51.Text = table.Rows(0)(53).ToString()
                Form1.Label52.Text = table.Rows(0)(54).ToString()
                Form1.Label53.Text = table.Rows(0)(55).ToString()
                Form1.TextBox1.Text = table.Rows(0)(56).ToString()
                Form1.TextBox15.Text = table.Rows(0)(58).ToString()
            End Using
        Catch ex As Exception

...
Public Class Form7
    Private Sub Form7_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        RichTextBox1.AppendText("." + "B" + Form6.Label75.Text + "." + "C" + Form6.Label71.Text + "." + "M" + Form6.Label73.Text + vbNewLine)
        RichTextBox1.AppendText("." + "PAX" + "/" + Form6.Label20.Text + "/" + Form6.Label21.Text + "." + "PAD" + "/" + "0" + "/" + "0" + vbNewLine)
